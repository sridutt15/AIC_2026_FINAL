    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Bulleted insight text from verified findings — generated by
          deterministic templates, no LLM. Regenerating produces identical bullets.
        </p>
            ...
            <div className="mt-4 border-t border-gray-100 pt-4">
              ...
              <div className="mt-2 grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
                  ...
                  <ul className="mt-1 list-disc rounded-md border border-gray-200 bg-white p-3 pl-7 text-sm text-gray-700">
