...
export default function InsightsPage() {
  ...
  useEffect(() => {
    ...
    setError(null)
    setRegenerated(null)
    Promise.all([getInsight(kpiId, false, personaId), getRecommendationPackage(kpiId, personaId)])
      .then(([i, p]) => {
        setInsight(i)
        setPkg(p)
      })
  ...
  const handleRegenerate = () => {
    ...
    setLoading(true)
    setError(null)
    getInsight(kpiId, true, personaId)
      .then((i) => {
        setInsight(i)
        setRegenerated(i)
      })
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Persona-specific insight text from verified findings — generated by
          deterministic templates, no LLM. Regenerating produces identical text.
        </p>
            ...
            <div className="mt-4 border-t border-gray-100 pt-4">
              ...
              <div className="mt-2 grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
                  ...
                  <p className="mt-1 rounded-md border border-gray-200 bg-white p-3 text-sm text-gray-700">
                    {insight.text}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500">Regenerated</p>
                  <p className="mt-1 rounded-md border border-gray-200 bg-white p-3 text-sm text-gray-700">
                    {regenerated.text}
                  </p>
                </div>
